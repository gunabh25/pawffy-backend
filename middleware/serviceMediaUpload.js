...
module.exports = {
  single: (field) => chain(serviceMediaUpload.single(field), magic),
  array: (field, maxCount) => chain(serviceMediaUpload.array(field, maxCount), magic),
  fields: (fields) => chain(serviceMediaUpload.fields(fields), magic),
};
